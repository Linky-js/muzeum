  ...
  <div class="wrapper-content">
    ...
    <div class="content relative">
      <div class="content__top">
        <h1 class="content__title">Метаболический синдром</h1>
        <RouterLink to="/" class="to-back">
          <IconArrow class="to-back__icon" />
          <span class="to-back__text">Назад</span>
        </RouterLink>
      </div>
      <div class="content__btns">
        <h3 class="content__btns-title">Компоненты Метаболического Синдрома</h3>
        <div class="content__btns-top">
          <GlassBtn link="/kms" name="Ожирение" />
          <GlassBtn link="/kms" name="Дислипидемия" />
          <GlassBtn link="/kms" name="Сердечная недостаточность" />
          <GlassBtn link="/kms" name="Сахарный диабет II типа" />
          <GlassBtn link="/kms" name="Хроническая болезнь почек" />
          <GlassBtn link="/kms" name="Артериальная гипертензия" />
        </div>
