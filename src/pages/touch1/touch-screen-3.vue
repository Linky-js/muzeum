...
function touchSendVideo(chapter) {
  bus.send('msVideos', { chapter }, { role: 'monitor', pairId: '1' })
    ...
    <div class="content relative">
      ...
      <div class="content__btns">
        ...
        <div class="content__btns-top ">
          ...
          <GlassBtn @click="touchSendVideo(null)" class="animBtnBottom" name="Сахарный диабет II типа" />
