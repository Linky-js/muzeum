  ...
  <div class="wrapper-content">
    ...
    <div class="content relative">
      <div class="content__top">
        <h1 class="content__title">DATA SCIENCE</h1>
        <p class="content__subtitle">Области применения ИИ</p>
        <RouterLink to="/touch-screen-2" class="to-back">
      ...
      <div class="content__btns">
        <div class="content__btns-top">
          <GlassBtn link="kms" name="Образование и кадры" />
          <GlassBtn link="kms" name="AI management" />
          <GlassBtn link="kms" name="Personification" />
          <GlassBtn link="kms" name="AI - telehealth" />
          <GlassBtn link="kms" name="Диагностика" />
          <GlassBtn link="kms" name="AI - epidemiology" />
          <GlassBtn class="grid-col-2" link="kms" name="AI Pharma" />
        </div>
      </div>
    </div>
