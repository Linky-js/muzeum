...
<template>
  <div class="conclusion-wrapper">
    <div class="conclusion">
      ...
      <!-- Дислипидемия -->
      <div
        class="conclusion_item relative dyslipidemia"
        v-if="dyslipidemiaData.hasContent"
      >
      ...
      <!-- Хроническая болезнь почек -->
      <div
        class="conclusion_item relative kidneys"
        v-if="kidneysData.hasContent"
      >
        <div class="__item--head">
          <IconPochki />
          <span>Хроническая болезнь почек</span>
        </div>
      ...
      <!-- Сердечно-сосудистые заболевания -->
      <div
        class="conclusion_item relative vessels"
        v-if="vesselsData.hasContent"
      >
        <div class="__item--head">
          <IconHeart />
...
.conclusion {
  ...
  display: grid;
  padding: 24px 64px;
background: linear-gradient(111deg, rgb(217 217 217 / 2%) 3.83%, rgb(123 101 39 / 10%) 99.95%);
...
.tint {
  ...
  background: linear-gradient(60deg, rgb(255 255 255 / 8%) 3.83%, rgb(20 20 20 / 10%) 99.95%)
}
.conclusion_item {
  padding: 40px 0;
