...
const emit = defineEmits(['scrollDirection']);
...
<template>
  ...
  <div class="content" :class="{ 'not-mobile': !isNotMobile }">
    ...
    <div class="content__inner" :class="{
      'full-width': step === 4 || step === 5,
      'not-mobile': !isNotMobile,
    }">
      <Step1 v-if="step === 1" class="step1" :person="person" :step="step" :goNextStep="goNextStep" view="mobile" />
      <Step2 v-if="step === 2" class="step2" :person="person" :step="step" :goNextStep="goNextStep" view="mobile" />
      <Step3 v-if="step === 3" class="step3" :person="person" :step="step" :goNextStep="goNextStep" view="mobile" />
