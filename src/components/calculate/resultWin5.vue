...
const dyslipidemia = computed(() => {
  ...
  if (arteriya === "Да" && d === "Нет") {
    return `
      ...
      <p>
       Типично риск дислипидемии для таких показателей повышен —<br /> он встречается у людей с артериальной гипертензией в 1,2–1,5 раза чаще,  чем у остальных.<br /><br />

        Снижение липопротеинов низкой плотности (“плохого” холестерина) на 1 ммоль/л уменьшает риски: смерти от всех причин — на 10%, сердечно-сосудистой смерти — на 20%, инсульта — на 17%, коронарных событий —<br />
        на 23%
