...
function focusRegion(regionObject) {
  ...
  if (regionObject.type === 'oblast') {
    switch (regionObject.oblast) {
      case 'Тверская область':
        viewBoxParams = `${centerX - bbox.width / 2 - 1000} ${centerY - bbox.height / 2 - 450} ${bbox.width + 2900} ${bbox.height + 900}`;
        break;
      case 'Ярославская область':
        viewBoxParams = `${centerX - bbox.width / 2 - 700} ${centerY - bbox.height / 2 - 450} ${bbox.width + 2000} ${bbox.height + 900}`;
        break;
      case 'Московская область':
        viewBoxParams = `${centerX - bbox.width / 2 - 900} ${centerY - bbox.height / 2 - 600} ${bbox.width + 2500} ${bbox.height + 1000}`;
        break;
      case 'Брянская область':
        viewBoxParams = `${centerX - bbox.width / 2 - 750} ${centerY - bbox.height / 2 - 450} ${bbox.width + 2100} ${bbox.height + 900}`;
        break;
      ...
      case 'Тульская область':
        viewBoxParams = `${centerX - bbox.width / 2 - 750} ${centerY - bbox.height / 2 - 400} ${bbox.width + 2100} ${bbox.height + 800}`;
        break;
      ...
      case 'Республика Карелия':
        viewBoxParams = `${centerX - bbox.width / 2 - 1400} ${centerY - bbox.height / 2 - 500} ${bbox.width + 4000} ${bbox.height + 1000}`;
        break;
      case 'Республика Коми':
        viewBoxParams = `${centerX - bbox.width / 2 - 2500} ${centerY - bbox.height / 2 - 1750} ${bbox.width + 7200} ${bbox.height + 2500}`;
        break;
      case 'Калининградская область':
        viewBoxParams = `${centerX - bbox.width / 2 - 375} ${centerY - bbox.height / 2 - 450} ${bbox.width + 1050} ${bbox.height + 900}`;
        break;
      ...
      case 'Республика Северная Осетия-Алания':
        viewBoxParams = `${centerX - bbox.width / 2 - 250} ${centerY - bbox.height / 2 - 450} ${bbox.width + 1050} ${bbox.height + 900}`;
        break;
      ...
      case 'Республика Мордовия':
        viewBoxParams = `${centerX - bbox.width / 2 - 450} ${centerY - bbox.height / 2 - 400} ${bbox.width + 1500} ${bbox.height + 800}`;
        break;
      ...
      case 'Чувашская Республика':
        viewBoxParams = `${centerX - bbox.width / 2 - 350} ${centerY - bbox.height / 2 - 450} ${bbox.width + 1050} ${bbox.height + 900}`;
        break;
      ...
      case 'Ханты-Мансийский АО - Югра':
        viewBoxParams = `${centerX - bbox.width / 2 - 2450} ${centerY - bbox.height / 2 - 1600} ${bbox.width + 7200} ${bbox.height + 2500}`;
        break;
  ...
  if (regionObject.type === 'gorod') {
    switch (regionObject.gorod) {
      case 'Тверь':
        viewBoxParams = `${centerX - bbox.width / 2 - 1500} ${centerY - bbox.height / 2 - 1300} ${bbox.width + 4000} ${bbox.height + 2250}`;
        break;
      case 'Ярославль':
        viewBoxParams = `${centerX - bbox.width / 2 - 900} ${centerY - bbox.height / 2 - 800} ${bbox.width + 2500} ${bbox.height + 1500}`;
        break;
      case 'Брянск':
        viewBoxParams = `${centerX - bbox.width / 2 - 1000} ${centerY - bbox.height / 2 - 800} ${bbox.width + 2500} ${bbox.height + 1500}`;
        break;
      case 'Калуга':
        viewBoxParams = `${centerX - bbox.width / 2 - 1000} ${centerY - bbox.height / 2 - 850} ${bbox.width + 2500} ${bbox.height + 1500}`;
        break;
      case 'Орел':
        viewBoxParams = `${centerX - bbox.width / 2 - 550} ${centerY - bbox.height / 2 - 550} ${bbox.width + 1500} ${bbox.height + 1000}`;
        break;
      case 'Тула':
        viewBoxParams = `${centerX - bbox.width / 2 - 950} ${centerY - bbox.height / 2 - 750} ${bbox.width + 2500} ${bbox.height + 1500}`;
        break;
      case 'Петрозаводск':
        viewBoxParams = `${centerX - bbox.width / 2 - 1600} ${centerY - bbox.height / 2 - 1600} ${bbox.width + 4500} ${bbox.height + 3000}`;
        break;
      case 'Сыктывкар':
        viewBoxParams = `${centerX - bbox.width / 2 - 2500} ${centerY - bbox.height / 2 - 1800} ${bbox.width + 7200} ${bbox.height + 3000}`;
        break;
      case 'Астрахань':
        viewBoxParams = `${centerX - bbox.width / 2 - 900} ${centerY - bbox.height / 2 - 1500} ${bbox.width + 2500} ${bbox.height + 3000}`;
        break;
      case 'Волгоград':
        viewBoxParams = `${centerX - bbox.width / 2 - 1100} ${centerY - bbox.height / 2 - 800} ${bbox.width + 3000} ${bbox.height + 1200}`;
        break;
      case 'Республика Мордовия, рп Зубова Поляна':
        viewBoxParams = `${centerX - bbox.width / 2 - 450} ${centerY - bbox.height / 2 - 400} ${bbox.width + 1500} ${bbox.height + 800}`;
        break;
      case 'Сургут':
        viewBoxParams = `${centerX - bbox.width / 2 - 2550} ${centerY - bbox.height / 2 - 1750} ${bbox.width + 7200} ${bbox.height + 3000}`;
        break;
      case 'Ханты-Мансийск':
        viewBoxParams = `${centerX - bbox.width / 2 - 2550} ${centerY - bbox.height / 2 - 1750} ${bbox.width + 7200} ${bbox.height + 3000}`;
        break;
      case 'Иркутск':
        viewBoxParams = `${centerX - bbox.width / 2 - 1800} ${centerY - bbox.height / 2 - 2300} ${bbox.width + 5000} ${bbox.height + 4500}`;
        break;
      case 'Красноярск':
        viewBoxParams = `${centerX - bbox.width / 2 - 1800} ${centerY - bbox.height / 2 - 2300} ${bbox.width + 5000} ${bbox.height + 4500}`;
        break;
      ...
      case 'Хабаровск':
        ...
        break;
      case 'Улан-Удэ':
        viewBoxParams = `${centerX - bbox.width / 2 - 2460} ${centerY - bbox.height / 2 - 1250} ${bbox.width + 7000} ${bbox.height + 2500}`;
        break;
      default:
        viewBoxParams = `${centerX - bbox.width / 2 - 900} ${centerY - bbox.height / 2 - 700} ${bbox.width + 2500} ${bbox.height + 1500}`;
        break;
    }
  }
  gsap.to(svgDoc.value.documentElement, {
